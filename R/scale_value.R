...
#'
#' This function, combined with [scale_axis()], makes it easy to use a secondary axis in ggplot. Simply supply the possible values for both axes to rescale values for the secondary axis.
...
#' Simply put: `value = (shift + value) / scale`
#'
...
#'                                        name="Log"))
#'
scale_value = function (value, first, second) {
